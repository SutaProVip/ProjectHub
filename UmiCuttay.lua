...
_G.AutoFullySuperhuman = true
	...
	game.StarterGui:SetCore("SendNotification", {
		Title = "Umi Cuttay Hub Notification", 
		Text = "Loading Script...",
...
wait(0.2)
	game.StarterGui:SetCore("SendNotification", {
		Title = "Umi Cuttay Hub Notification", 
		Text = "Wellcome to Umi Hub Ver Cuttay Premium Script",
		Icon = "http://www.roblox.com/asset/?id=14334760790",
		Duration = 2
	})
	wait(0.1)
...
local library = {
	WorkspaceName = "UMI HUB VERSION CUTTAY",
	flags = {},
	signals = {},
	objects = {},
	elements = {},
...
local PepsiUi = library:CreateWindow({
    Name = "Umi Hub Utimate Cuttay Script",
    Theme = {
        Image = "rbxassetid://7483871523",
        Info = "UMI HUB CUTTAY SCRIPT",
        Background = {
